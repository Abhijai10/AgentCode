# WP-P19-WP02 - AI threat model and trust-boundary graph
...
AI threat model and trust-boundary graph.

## Implementation Summary

Added AiTrustBoundaryGraph with untrusted flows across user, retrieval, tool, MCP and memory boundaries.
