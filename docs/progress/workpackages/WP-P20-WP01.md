# WP-P20-WP01 - Discussion Session
...
Persist discussion sessions/messages/context refs/accepted decisions separately from Kernel mission state.

## Implementation Summary

DiscussSession/DiscussMessage domain types plus discuss_sessions/discuss_messages APIs persist recoverable discussion state.
