# WP-P19-WP06 - Secret and sensitive-output leakage tests
...
Secret and sensitive-output leakage tests.

## Implementation Summary

Added synthetic secret leakage fixture with redacted evidence and critical severity.
