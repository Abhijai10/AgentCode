# WP-P29-WP01 — Freeze release commit and version metadata

Status: ACCEPTED

Objective: Freeze release commit and version metadata.

Implementation summary: FinalReleaseManifest records version, artifacts, migrations, checksums and limitations.
