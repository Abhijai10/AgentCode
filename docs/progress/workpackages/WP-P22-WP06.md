...
Mission surface uses real Kernel state.

## Implementation Summary

MissionProgressProjection carries MissionState/current phase/action/blocker/approval metadata.
