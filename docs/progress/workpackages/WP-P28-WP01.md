# WP-P28-WP01 — RC branch, scope freeze and change policy

Status: ACCEPTED

Objective: RC branch, scope freeze and change policy.

Implementation summary: ReleaseCandidate captures candidate identity, commit, build and freeze evidence; gate rejects approval without evidence.
