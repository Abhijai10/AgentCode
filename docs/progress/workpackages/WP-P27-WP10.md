...
## Objective
Implement Uninstall and reset behavior as production-integrated release-preparation functionality without creating a parallel subsystem.

## Implementation Summary
Reset plan removes AgentCode cache/index paths without deleting user repositories.
