# WP-P28-WP09 — Discuss, Design and desktop UX matrix

Status: ACCEPTED

Objective: Discuss, Design and desktop UX matrix.

Implementation summary: RC evidence records required Discuss, Design and UX gates as release validation inputs.
