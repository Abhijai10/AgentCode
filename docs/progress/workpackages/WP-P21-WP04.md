...
Infer durable type/spacing/radii/surface/color/navigation/motion/icon/component principles.

## Implementation Summary

DesignStudio::infer_grammar turns analysis and brief into DesignGrammar with provenance refs.
