# WP-P18-WP01 - Authorization and active-test scope model
...
Authorization and active-test scope model.

## Implementation Summary

Persisted ActiveAuthorization with target, environment, scope, credentials, rate/concurrency, forbidden actions, expiry and cleanup requirement; active runner rejects missing or out-of-scope authorization.
