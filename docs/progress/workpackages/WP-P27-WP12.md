...
## Objective
Implement Signing/notarization release pipeline as production-integrated release-preparation functionality without creating a parallel subsystem.

## Implementation Summary
Release policy records signed/provenanced artifact requirement and honest manual-update fallback.
