...
## Objective
Implement Process, tool, LSP and browser fault scenarios as production-integrated Phase 24 functionality without creating a parallel subsystem.

## Implementation Summary
Tool hang, process-tree leak, LSP crash and browser crash scenarios with timeout, cleanup, degraded fallback and stale-proof invalidation behavior.
