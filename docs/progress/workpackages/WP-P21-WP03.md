...
Generate product-specific audience/workflow/personality/avoidance guidance.

## Implementation Summary

DesignStudio::generate_brief builds DesignBrief with hard product identity, audience, workflow, visual goals and anti-patterns.
