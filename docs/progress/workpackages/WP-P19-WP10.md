# WP-P19-WP10 - PyRIT optional advanced adapter
...
PyRIT optional advanced adapter.

## Implementation Summary

Added PyRIT optional adapter status as OptionalUnavailable unless selected/installed; baseline remains satisfied by native fixtures.
