...
Convert discussion outputs into requirements, tasks, constraints and open questions.

## Implementation Summary

DiscussMode::promote_to_plan validates requirements/tasks and returns a structured DiscussPlan with inherited decision refs.
