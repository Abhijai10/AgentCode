...
## Objective
Implement Chaos repetition, seeding and isolation as production-integrated Phase 24 functionality without creating a parallel subsystem.

## Implementation Summary
All catalog scenarios require the configured minimum repeated seeded runs before acceptance; insufficient repetition is rejected.
