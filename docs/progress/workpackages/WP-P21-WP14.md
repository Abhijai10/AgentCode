# WP-P21-WP14 - DOM-source Prototype
...
Provide guarded DOM selector to source-file mapping when robust enough.

## Implementation Summary

DesignStudio::map_dom_to_source prefers data-source attributes, falls back to selector text search, and returns confidence/limitations.
