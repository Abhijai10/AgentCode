...
Snapshot/reconnect path between desktop and daemon without renderer authority.

## Implementation Summary

ac-daemon handles DesktopWindowClosed/ReconnectDesktop while leaving daemon running.
