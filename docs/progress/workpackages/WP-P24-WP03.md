...
## Objective
Implement Worker, scheduler and lease fault scenarios as production-integrated Phase 24 functionality without creating a parallel subsystem.

## Implementation Summary
Worker death, planner death, duplicate IPC and zombie-worker fencing scenarios with lease/replacement recovery evidence.
