...
## Objective
Implement Clean-Mac and external-SSD acceptance as production-integrated release-preparation functionality without creating a parallel subsystem.

## Implementation Summary
Layout tests cover external-drive/path-with-spaces repository separation from app state.
