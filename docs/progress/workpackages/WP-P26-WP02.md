...
## Objective
Implement Workspace and sandbox escape campaign as production-integrated release-preparation functionality without creating a parallel subsystem.

## Implementation Summary
Boundary campaign records workspace escape regression status and keeps release blocked if an escape test fails.
