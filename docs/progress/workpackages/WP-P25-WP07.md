...
## Objective
Implement Discuss-to-Mission dogfood flow as production-integrated Phase 25 functionality without creating a parallel subsystem.

## Implementation Summary
Discuss promotion mission class preserves structural mission objective/evidence and accepted proposal state.
