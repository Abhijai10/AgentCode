# WP-P19-WP05 - Tool and MCP abuse tests
...
Tool and MCP abuse tests.

## Implementation Summary

Added destructive synthetic tool and MCP trust-abuse fixtures; findings normalize to common ai-tool-abuse root cause.
