...
## Objective
Implement Prompt-injection, MCP and Skill adversarial dogfood as production-integrated Phase 25 functionality without creating a parallel subsystem.

## Implementation Summary
Adversarial mission classes model malicious repo/MCP/Skill inputs as data, preserving policy boundary and no bypass.
