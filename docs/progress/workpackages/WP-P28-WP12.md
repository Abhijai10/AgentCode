# WP-P28-WP12 — Upgrade and rollback matrix

Status: ACCEPTED

Objective: Upgrade and rollback matrix.

Implementation summary: MigrationSafetyReport requires fresh install, upgrade, schema v18 and interrupted recovery evidence.
