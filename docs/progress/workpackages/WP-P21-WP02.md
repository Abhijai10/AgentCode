...
Analyze existing UI/product implementation before generating changes.

## Implementation Summary

ProductAnalysis records framework/routes/components/style/tokens/assets/navigation plus evidence ref.
