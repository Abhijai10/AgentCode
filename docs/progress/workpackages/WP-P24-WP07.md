...
## Objective
Implement Network, disk, memory and external-drive fault scenarios as production-integrated Phase 24 functionality without creating a parallel subsystem.

## Implementation Summary
Disk pressure, network/provider outage, external-drive disconnect and low-memory scenarios with safe failure or degraded continuation.
