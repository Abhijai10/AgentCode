...
Preview-centric Design Studio surface integration.

## Implementation Summary

DesktopView::Design is part of shell routing and shares Design Studio backend projections.
