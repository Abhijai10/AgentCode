# WP-P18-WP08 - Cloud credential scope and read-only policy
...
Cloud credential scope and read-only policy.

## Implementation Summary

Cloud resources are checked against authorized accounts; credential refs are durable metadata only and read-only posture is the default.
