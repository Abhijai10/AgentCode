# WP-P19-WP01 - AI attack-surface detector
...
AI attack-surface detector.

## Implementation Summary

Added deterministic detector for model gateways, prompts, RAG, vector stores, tools, MCP, agents, memory and secret sources.
