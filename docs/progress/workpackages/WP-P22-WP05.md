...
Enter user goal and attach mission.

## Implementation Summary

DesktopExperience::compose_goal uses Goal::new and attach_mission binds a Kernel mission id.
