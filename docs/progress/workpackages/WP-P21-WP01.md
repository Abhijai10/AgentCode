# WP-P21-WP01 - Design Context Profile
...
Use product/design context derived from real repository files.

## Implementation Summary

DesignStudio::analyze_product extracts framework, routes, components, styles, tokens, fonts, assets, navigation and baseline screens.
