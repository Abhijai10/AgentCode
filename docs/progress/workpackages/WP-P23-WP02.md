# WP-P23-WP02 - Resource Governor tuning
...
Enforce max workers, budget and pressure degraded mode.

## Implementation Summary

OptimizationEngine::govern reduces admitted workers under CPU/memory/budget pressure.
