# WP-P23-WP11 - Daemon and desktop performance tuning
...
Keep UI/daemon lifecycle responsive under resource policy.

## Implementation Summary

Desktop state is snapshot-based; daemon close/reconnect avoids stopping active missions.
