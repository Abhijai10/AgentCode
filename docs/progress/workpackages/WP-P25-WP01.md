...
## Objective
Implement Dogfood mission policy and harness as production-integrated Phase 25 functionality without creating a parallel subsystem.

## Implementation Summary
DogfoodHarness runs self missions through normal AgentCode mission records, evidence references, ChangeSet and verification state without privileged bypass.
