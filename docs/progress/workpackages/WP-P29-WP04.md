# WP-P29-WP04 — Release notes, SBOM and notices

Status: ACCEPTED

Objective: Release notes, SBOM and notices.

Implementation summary: README, CHANGELOG, LIMITATIONS, SECURITY and release docs document V1 claims.
