...
## Objective
Implement SBOM and third-party notices as production-integrated release-preparation functionality without creating a parallel subsystem.

## Implementation Summary
SBOM generation is implemented and release/SBOM plus THIRD_PARTY_NOTICES artifacts exist.
