...
Critic catches seeded generic UI failure modes.

## Implementation Summary

DesignStudio::critique flags oversized gradient heroes, generic card repetition, generic AI copy and gratuitous glass styling.
