# WP-P19-WP03 - Direct and indirect prompt-injection fixtures
...
Added synthetic direct and indirect injection attack cases with expected policy outcomes and normalized findings.
