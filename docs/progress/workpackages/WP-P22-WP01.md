...
Application shell lifecycle, navigation and typed window/session state.

## Implementation Summary

DesktopExperience creates/restores sessions, tracks views, window state and details availability.
