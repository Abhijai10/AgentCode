# WP-P29-WP03 — Release artifact build, hash and signature

Status: ACCEPTED

Objective: Release artifact build, hash and signature.

Implementation summary: ReleaseArtifact records exact integrity hash and source commit; unsigned status remains limitation.
