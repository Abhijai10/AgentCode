# WP-P23-WP04 - Local-model lifecycle tuning
...
Lazy/idle unload and pressure unload.

## Implementation Summary

OptimizationEngine::local_model_lifecycle returns unload decisions under idle or memory pressure.
