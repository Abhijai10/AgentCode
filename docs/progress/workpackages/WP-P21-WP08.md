...
Represent preview iteration results through verification evidence.

## Implementation Summary

DesignStudio::run_preview_iteration connects artifact version, visual evaluation, responsive QA, accessibility QA and functional QA.
