# WP-P18-WP04 - Nuclei adapter and template provenance
...
Nuclei adapter and template provenance.

## Implementation Summary

Added native Nuclei-compatible template probe with scope enforcement and template provenance string recorded in adapter evidence.
