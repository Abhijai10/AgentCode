# WP-P23-WP09 - Routing-history and model-selection tuning
...
Choose model based on cost/quality/latency requirements.

## Implementation Summary

ProviderRegistry::select_cost_optimized_route filters ranked candidates by CostTier and quality.
