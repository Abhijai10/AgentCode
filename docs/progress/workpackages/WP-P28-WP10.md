# WP-P28-WP10 — 8 GB performance and resource matrix

Status: ACCEPTED

Objective: 8 GB performance and resource matrix.

Implementation summary: Performance is an explicit validation step required before candidate approval.
