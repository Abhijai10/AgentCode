# WP-P23-WP03 - Adaptive Worker concurrency
...
No fixed worker count; adapt to policy/snapshot.

## Implementation Summary

ResourceGovernorDecision calculates admitted worker count per snapshot and requested fanout.
