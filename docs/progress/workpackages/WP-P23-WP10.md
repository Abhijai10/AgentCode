# WP-P23-WP10 - Paid-budget and cost controls
...
Track spend and enforce budget pressure.

## Implementation Summary

ResourcePolicy budget_limit_micros and TokenUsageRecord estimated_cost_micros feed governor/report.
