...
## Objective
Implement Update and rollback workflow as production-integrated release-preparation functionality without creating a parallel subsystem.

## Implementation Summary
Update plans verify integrity, decide install/block/current, and record rollback recovery actions.
