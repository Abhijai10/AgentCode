# WP-P20-WP05 - Research Integration
...
Allow researcher augmentation while continuing when optional research is unavailable.

## Implementation Summary

DiscussMode::integrate_research records researcher output or degraded-unavailable summary as evidence-backed discussion message.
