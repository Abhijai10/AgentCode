...
Completion/Needs-User/failure notifications only.

## Implementation Summary

DesktopExperience::notify suppresses provider failover spam and creates privacy-safe notifications.
