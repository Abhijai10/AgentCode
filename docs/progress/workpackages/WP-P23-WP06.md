# WP-P23-WP06 - SCIP and Zoekt activation thresholds
...
Optional heavy indexes obey benefit/cost threshold.

## Implementation Summary

OptimizationEngine::heavy_index_policy enables only large/reused/non-critical workloads.
