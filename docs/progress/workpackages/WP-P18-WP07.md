# WP-P18-WP07 - Prowler cloud posture adapter
...
Prowler cloud posture adapter.

## Implementation Summary

Added Prowler-compatible read-only cloud posture adapter that normalizes public resources and wildcard permissions.
