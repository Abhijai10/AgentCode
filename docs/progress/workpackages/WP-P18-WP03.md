...
Added native ZAP-compatible deterministic adapter for scoped local/staging/lab DAST fixture execution and seeded vulnerability evidence when external ZAP is unavailable.
