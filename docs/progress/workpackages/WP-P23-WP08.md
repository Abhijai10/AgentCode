# WP-P23-WP08 - Tool-output compression tuning
...
Measure raw vs compressed token savings.

## Implementation Summary

TokenUsageRecord stores context_tokens/compressed_tokens and compression_ratio.
