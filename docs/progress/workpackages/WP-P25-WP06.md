...
## Objective
Implement Provider-failure and restart dogfood mission as production-integrated Phase 25 functionality without creating a parallel subsystem.

## Implementation Summary
Provider-failure and restart mission classes record provider switches, worker replacements and verified continuation.
