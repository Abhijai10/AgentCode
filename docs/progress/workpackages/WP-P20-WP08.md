...
Create a standard Kernel mission draft without replaying the transcript.

## Implementation Summary

DiscussMode::promote_to_mission creates a normal Goal, carries accepted decisions, and sets transcript_replay_required=false.
