# WP-P28-WP04 — Repository support matrix

Status: ACCEPTED

Objective: Repository support matrix.

Implementation summary: RC validation records repository matrix evidence references and blocks missing evidence.
