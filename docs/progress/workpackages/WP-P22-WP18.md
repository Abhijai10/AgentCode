# WP-P22-WP18 - Theme/accessibility
...
Appearance, reduced motion and keyboard-accessible view routing.

## Implementation Summary

DesktopAppearance/DesktopView provide typed System/Light/Dark and semantic navigation state.
