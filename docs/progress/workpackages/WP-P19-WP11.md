# WP-P19-WP11 - AI-security finding normalization
...
AI-security finding normalization.

## Implementation Summary

AI fixture findings flow through BaselineSecurityOrchestrator grouping/triage and are persisted in the common security_findings table.
