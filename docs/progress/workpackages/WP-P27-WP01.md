...
## Objective
Implement Release packaging manifest as production-integrated release-preparation functionality without creating a parallel subsystem.

## Implementation Summary
Release artifact/version model and packaging manifest define desktop, daemon, migrations, tools, paths and metadata.
