# WP-P29-WP06 — Tag, publish and archive

Status: ACCEPTED

Objective: Tag, publish and archive.

Implementation summary: ReleaseDecisionRecord and ReleaseEvidenceBundle persist immutable approval/archive references.
