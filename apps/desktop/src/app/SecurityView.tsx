  ...
  return (
    <main className="flex-1 flex overflow-hidden">
      ...
      {listCollapsed ? (
        ...
        <aside className="w-56 shrink-0 flex flex-col border-r border-outline-variant/40 dark:border-white/5 bg-surface/50 relative">
          <button
            onClick={() => setListCollapsed(true)}
            title="Collapse scans list"
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <button
          ...
          title="Show scan detail"
          className="shrink-0 w-8 border-l border-outline-variant/40 dark:border-white/5 bg-surface/50 flex items-center justify-center text-on-surface-variant hover:text-primary"
        >
          <Icon name="arrow_back" size={16} />
        </button>
      ) : (
        <aside className="w-80 shrink-0 border-l border-outline-variant/40 dark:border-white/5 flex flex-col bg-surface/30 relative">
          <button
            onClick={() => setDetailCollapsed(true)}
            title="Collapse scan detail"
            className="absolute top-2 left-2 z-10 p-1 rounded-lg text-on-surface-variant hover:bg-surface-variant/40 dark:hover:bg-white/5"
          >
